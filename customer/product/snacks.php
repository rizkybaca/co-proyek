<div class="container-store">
      <!-- start products -->
    <?php 
    $sql_cek="SELECT p.id_p,p.types,p.name_p,p.price,p.stocks,p.image,p.id_store FROM products AS p JOIN store AS s ON p.id_store=s.id WHERE s.id='$b'AND p.types='snacks'";
