	...
	<table>
	  ...
	  while($data_cek= mysqli_fetch_array($query_cek)) :?>
		<tr>
			...
			<td><?= $rl; ?></td>
			<td id="act">
				<a href="?page=detail-servant&kode=<?=$data_cek['id_v']; ?>">
				...
				<a href="?page=edit-servant&kode=<?=$data_cek['id_v']; ?>">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<a href="?page=del-servant&kode=<?=$data_cek['id_v']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
