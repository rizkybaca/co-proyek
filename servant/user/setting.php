<?php 
	$sql_cek="SELECT *FROM servant WHERE id='".$data_id."'";
	...
	<form action="" method="POST">
		...
		<div class="input">
			...
			<div class="col">
				...
				<input required type="text" name="name" id="name" placeholder="type name here" value="<?= $data_cek['name']; ?>">
			</div>
		</div>
		<div class="button">
...
//mulai proses simpan data
  ...
  if ($query_ubah) {
  	$_SESSION["ses_username_v"]=$_POST['username'];
  	$_SESSION["ses_password_v"]=$_POST['password'];
  	$_SESSION["ses_name_v"]=$_POST['name'];
  	echo "
  		<script>
