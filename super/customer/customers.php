	...
	<table>
	  ...
	  while($data_cek= mysqli_fetch_array($query_cek)) :?>
		<tr>
			...
			<td id="act">
				<a href="?page=detail-customer&kode=<?=$data_cek['id']; ?>">
				...
				<a href="?page=edit-customer&kode=<?=$data_cek['id']; ?>">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<a href="?page=del-customer&kode=<?=$data_cek['id']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
